    ...
    public class BilatuController : Controller
    {
        ...
        public async Task<ActionResult> Book(FormCollection collection)
        {
            try
            {
                ...
                Session["erabiltzailea_emaila"] = erabiltzailea_emaila;
        ...
        public async Task<ActionResult> allBooks(string email)
        {
            try
            {
                ...
                using (var client = new HttpClient())
                {
                    ...
                    //Sending request to find web api REST service resource GetAllEmployees using HttpClient  
                    HttpResponseMessage Res = await client.GetAsync("errenta/emaila?emaila=" + email);
